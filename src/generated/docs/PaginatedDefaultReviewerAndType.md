...
**values** | [**Set&lt;DefaultReviewerAndType&gt;**](DefaultReviewerAndType.md) |  | [optional] [default to undefined]

## Example

```typescript
import { PaginatedDefaultReviewerAndType } from './api';

const instance: PaginatedDefaultReviewerAndType = {
    size,
    page,
    pagelen,
    next,
