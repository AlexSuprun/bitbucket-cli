...
**values** | [**Array&lt;IssueAttachment&gt;**](IssueAttachment.md) |  | [optional] [default to undefined]

## Example

```typescript
import { PaginatedIssueAttachments } from './api';

const instance: PaginatedIssueAttachments = {
    size,
    page,
    pagelen,
    next,
