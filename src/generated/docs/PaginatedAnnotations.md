...
**values** | [**Array&lt;ReportAnnotation&gt;**](ReportAnnotation.md) | The values of the current page. | [optional] [default to undefined]
...
```typescript
import { PaginatedAnnotations } from './api';

const instance: PaginatedAnnotations = {
    page,
    values,
    size,
    pagelen,
