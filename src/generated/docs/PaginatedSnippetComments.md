...
**values** | [**Set&lt;SnippetComment&gt;**](SnippetComment.md) |  | [optional] [default to undefined]

## Example

```typescript
import { PaginatedSnippetComments } from './api';

const instance: PaginatedSnippetComments = {
    size,
    page,
    pagelen,
    next,
