...
**values** | [**Array&lt;PipelineKnownHost&gt;**](PipelineKnownHost.md) | The values of the current page. | [optional] [default to undefined]
...
```typescript
import { PaginatedPipelineKnownHosts } from './api';

const instance: PaginatedPipelineKnownHosts = {
    page,
    values,
    size,
    pagelen,
