...
**values** | [**Array&lt;PipelineCache&gt;**](PipelineCache.md) | The values of the current page. | [optional] [default to undefined]
...
```typescript
import { PaginatedPipelineCaches } from './api';

const instance: PaginatedPipelineCaches = {
    page,
    values,
    size,
    pagelen,
