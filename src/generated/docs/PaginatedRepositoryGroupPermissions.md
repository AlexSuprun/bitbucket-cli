...
**values** | [**Set&lt;RepositoryGroupPermission&gt;**](RepositoryGroupPermission.md) |  | [optional] [default to undefined]

## Example

```typescript
import { PaginatedRepositoryGroupPermissions } from './api';

const instance: PaginatedRepositoryGroupPermissions = {
    size,
    page,
    pagelen,
    next,
