...
**values** | [**Array&lt;Pipeline&gt;**](Pipeline.md) | The values of the current page. | [optional] [default to undefined]
...
```typescript
import { PaginatedPipelines } from './api';

const instance: PaginatedPipelines = {
    page,
    values,
    size,
    pagelen,
