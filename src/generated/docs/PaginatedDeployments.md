...
**values** | [**Array&lt;Deployment&gt;**](Deployment.md) | The values of the current page. | [optional] [default to undefined]
...
```typescript
import { PaginatedDeployments } from './api';

const instance: PaginatedDeployments = {
    page,
    values,
    size,
    pagelen,
