...
**values** | [**Array&lt;Report&gt;**](Report.md) | The values of the current page. | [optional] [default to undefined]
...
```typescript
import { PaginatedReports } from './api';

const instance: PaginatedReports = {
    page,
    values,
    size,
    pagelen,
