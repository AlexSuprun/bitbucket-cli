...
**values** | [**Array&lt;PipelineSchedule&gt;**](PipelineSchedule.md) | The values of the current page. | [optional] [default to undefined]
...
```typescript
import { PaginatedPipelineSchedules } from './api';

const instance: PaginatedPipelineSchedules = {
    page,
    values,
    size,
    pagelen,
