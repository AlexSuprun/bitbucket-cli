...
**pagelen** | **number** | Current number of objects on the existing page. The default value is 500 with 5000 being the maximum allowed value. | [optional] [default to undefined]
...
**values** | [**Set&lt;Diffstat&gt;**](Diffstat.md) |  | [optional] [default to undefined]

## Example

```typescript
import { PaginatedDiffstats } from './api';

const instance: PaginatedDiffstats = {
    size,
    page,
    pagelen,
    next,
