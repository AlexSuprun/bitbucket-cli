...
**values** | [**Array&lt;DeploymentEnvironment&gt;**](DeploymentEnvironment.md) | The values of the current page. | [optional] [default to undefined]
...
```typescript
import { PaginatedEnvironments } from './api';

const instance: PaginatedEnvironments = {
    page,
    values,
    size,
    pagelen,
