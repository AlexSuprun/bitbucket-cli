...
**values** | [**Set&lt;ProjectUserPermission&gt;**](ProjectUserPermission.md) |  | [optional] [default to undefined]

## Example

```typescript
import { PaginatedProjectUserPermissions } from './api';

const instance: PaginatedProjectUserPermissions = {
    size,
    page,
    pagelen,
    next,
