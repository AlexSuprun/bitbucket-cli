...
**values** | [**Set&lt;ProjectGroupPermission&gt;**](ProjectGroupPermission.md) |  | [optional] [default to undefined]

## Example

```typescript
import { PaginatedProjectGroupPermissions } from './api';

const instance: PaginatedProjectGroupPermissions = {
    size,
    page,
    pagelen,
    next,
