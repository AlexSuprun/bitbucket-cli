...
**values** | [**Set&lt;RepositoryPermission&gt;**](RepositoryPermission.md) |  | [optional] [default to undefined]

## Example

```typescript
import { PaginatedRepositoryPermissions } from './api';

const instance: PaginatedRepositoryPermissions = {
    size,
    page,
    pagelen,
    next,
