...
**values** | [**Set&lt;Branchrestriction&gt;**](Branchrestriction.md) |  | [optional] [default to undefined]

## Example

```typescript
import { PaginatedBranchrestrictions } from './api';

const instance: PaginatedBranchrestrictions = {
    size,
    page,
    pagelen,
    next,
