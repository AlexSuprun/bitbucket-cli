...
**values** | [**Set&lt;PullrequestComment&gt;**](PullrequestComment.md) |  | [optional] [default to undefined]

## Example

```typescript
import { PaginatedPullrequestComments } from './api';

const instance: PaginatedPullrequestComments = {
    size,
    page,
    pagelen,
    next,
