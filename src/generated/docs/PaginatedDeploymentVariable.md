...
**values** | [**Array&lt;DeploymentVariable&gt;**](DeploymentVariable.md) | The values of the current page. | [optional] [default to undefined]
...
```typescript
import { PaginatedDeploymentVariable } from './api';

const instance: PaginatedDeploymentVariable = {
    page,
    values,
    size,
    pagelen,
