...
**values** | [**Array&lt;PipelineScheduleExecution&gt;**](PipelineScheduleExecution.md) | The values of the current page. | [optional] [default to undefined]
...
```typescript
import { PaginatedPipelineScheduleExecutions } from './api';

const instance: PaginatedPipelineScheduleExecutions = {
    page,
    values,
    size,
    pagelen,
