...
**values** | [**Set&lt;ProjectDeployKey&gt;**](ProjectDeployKey.md) |  | [optional] [default to undefined]

## Example

```typescript
import { PaginatedProjectDeployKeys } from './api';

const instance: PaginatedProjectDeployKeys = {
    size,
    page,
    pagelen,
    next,
