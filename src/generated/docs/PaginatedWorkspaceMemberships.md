...
**values** | [**Set&lt;WorkspaceMembership&gt;**](WorkspaceMembership.md) |  | [optional] [default to undefined]

## Example

```typescript
import { PaginatedWorkspaceMemberships } from './api';

const instance: PaginatedWorkspaceMemberships = {
    size,
    page,
    pagelen,
    next,
