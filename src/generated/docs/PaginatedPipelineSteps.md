...
**values** | [**Array&lt;PipelineStep&gt;**](PipelineStep.md) | The values of the current page. | [optional] [default to undefined]
...
```typescript
import { PaginatedPipelineSteps } from './api';

const instance: PaginatedPipelineSteps = {
    page,
    values,
    size,
    pagelen,
