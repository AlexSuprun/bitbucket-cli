...
**values** | [**Array&lt;PipelineVariable&gt;**](PipelineVariable.md) | The values of the current page. | [optional] [default to undefined]
...
```typescript
import { PaginatedPipelineVariables } from './api';

const instance: PaginatedPipelineVariables = {
    page,
    values,
    size,
    pagelen,
